	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/static/role/findAll.do">角色管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/views/permission-add.jsp'">
									...
									<c:forEach items="${permissionList}" var="permission">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/static/role/findById.do?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
