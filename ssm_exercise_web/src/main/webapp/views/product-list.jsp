...
<head>
    ...
    <title>产品 - zhouhao定制版</title>
    <meta name="description" content="zhouhao定制版">
    <meta name="keywords" content="zhouhao定制版">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="${pageContext.request.contextPath}/views/product-add.jsp"'><i
                            ...
                            <tbody>
                                <c:forEach items="${products}" var="product">
                                    <tr>
                                        ...
                                        <td class="text-center">${product.productStateStr }</td>
